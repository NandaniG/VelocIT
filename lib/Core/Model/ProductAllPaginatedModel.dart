class ProductAllPaginatedModel {
  String? status;
  Payload? payload;
  String? timestamp;

  ProductAllPaginatedModel({this.status, this.payload, this.timestamp});

  ProductAllPaginatedModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    payload =
