class BestDealModel {
  ...
  BestDealModel({this.status, this.payload, this.timestamp});

  BestDealModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    payload =
...
class Payload {
  ...
  Payload.fromJson(Map<String, dynamic> json) {
    if (json['content'] != null) {
      content = <BestDealContent>[];
      json['content'].forEach((v) {
        content!.add(new BestDealContent.fromJson(v));
      });
    }
...
class BestDealContent {
 ...
 var gstPercent;
  ...
  BestDealContent.fromJson(Map<String, dynamic> json) {
