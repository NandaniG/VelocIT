class MerchantListByIdModel {
  String? status;
  MerchantIDPayload? payload;
  String? timestamp;

  MerchantListByIdModel({this.status, this.payload, this.timestamp});

  MerchantListByIdModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    payload =
        json['payload'] != null ? new MerchantIDPayload.fromJson(json['payload']) : null;
...
class MerchantIDPayload {
  List<MerchantIdContent>? content;
  Pageable? pageable;
  int? totalPages;
  int? totalElements;
  bool? last;
  ...
  MerchantIDPayload.fromJson(Map<String, dynamic> json) {
    if (json['content'] != null) {
      content = <MerchantIdContent>[];
      json['content'].forEach((v) {
        content!.add(new MerchantIdContent.fromJson(v));
      });
    }
...
class MerchantIdContent {
 ...
 double? defaultSellPrice;
  ...
  MerchantIdContent.fromJson(Map<String, dynamic> json) {
