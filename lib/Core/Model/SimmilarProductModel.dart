class SimilarProductModel {
  ...
  SimilarProductModel({this.status, this.payload, this.timestamp});
  ...
  Payload.fromJson(Map<String, dynamic> json) {
    if (json['content'] != null) {
      ...
      json['content'].forEach((v) {
        content!.add(new SimilarContent.fromJson(v));
      });
    }
...
class SimilarContent {
 ...
 var gstPercent;
  ...
  List<SimilarProductsubCategory>? productsubCategory;
  ...
  SimilarContent.fromJson(Map<String, dynamic> json) {
    ...
    if (json['productsubCategory'] != null) {
      productsubCategory = <SimilarProductsubCategory>[];
      json['productsubCategory'].forEach((v) {
        productsubCategory!.add(new SimilarProductsubCategory.fromJson(v));
      });
    }
...
class SimilarProductsubCategory {
  String? productSubCategoryCode;
  int? productSubCategoryId;
  String? productSubcategoryName;

  SimilarProductsubCategory(
      {this.productSubCategoryCode,
        this.productSubCategoryId,
        this.productSubcategoryName});

  SimilarProductsubCategory.fromJson(Map<String, dynamic> json) {
