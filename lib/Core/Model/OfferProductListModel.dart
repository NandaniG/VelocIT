class OfferProductsListModel {
  String? status;
  PayloadOffer? payload;
  String? timestamp;

  OfferProductsListModel({this.status, this.payload, this.timestamp});

  OfferProductsListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    payload =
    json['payload'] != null ? new PayloadOffer.fromJson(json['payload']) : null;
...
class PayloadOffer {
  ...
  PayloadOffer.fromJson(Map<String, dynamic> json) {
    if (json['content'] != null) {
      content = <OfferListContent>[];
      json['content'].forEach((v) {
        content!.add(new OfferListContent.fromJson(v));
      });
    }
...
class OfferListContent {
  ...
  OfferListContent.fromJson(Map<String, dynamic> json) {
