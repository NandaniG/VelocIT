class FindCRMbySUbCategoriesModel {
  String? status;
  Payload? payload;
  String? timestamp;

  FindCRMbySUbCategoriesModel({this.status, this.payload, this.timestamp});

  FindCRMbySUbCategoriesModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    payload =
  ...
  Payload.fromJson(Map<String, dynamic> json) {
    if (json['content'] != null) {
      ...
      json['content'].forEach((v) {
        content!.add(new CRMContent.fromJson(v));
      });
    }
...
class CRMContent {
  ...
  CRMContent.fromJson(Map<String, dynamic> json) {
